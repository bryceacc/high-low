  ...
  getInitialState: function () {
    ...
    switch (this.props.suit) {
      ...
      case 4:
        ...
        break;
      default:
        console.log('error with cards suit ' + this.props.suit);
    }
    return { suit: soot };
  },
  componentDidMount: function () {},
  render: function () {
    return React.createElement('div', null, React.createElement('img', { src: '../resources/SVG-cards/' + this.props.val + '_of_' + this.state.suit + 's.svg' }));
  }
});
...
var Game = React.createClass({ displayName: "Game",
	...
	render: function () {
		...
		//show lobby
				...
				return React.createElement('div', null, React.createElement(Lobby, { play: this.gameStart, name: this.state.username, sock: socket }));
			}
